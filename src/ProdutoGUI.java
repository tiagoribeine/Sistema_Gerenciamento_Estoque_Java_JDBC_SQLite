...
public class ProdutoGUI extends Application{
    ...
    public void start(Stage palco){
        ...
        vbox.getChildren().addAll(nomeProdutoBox, quantidadeBox, precoBox, statusHbox, buttonBox,  tableView);
    ...
    //Metodo stop é chamado automaticamente quando a aplicação JavaFX
    @Override
    public void stop() {
        try {
            conexaoDB.close(); //Fecha a conexão com o banco de dados - Garante que a conexão seja fechada corretamente no momento certo
        }
    ...
    private void limparCampos(){
        /* Limpa os campos de entrada no formulário: É chamado após adicionar, atualizar ou excluir um produto
        Garante que os camposd eentrada estejam prontos para uma nova entrada
         */
        nomeInput.clear();
    ...
    /**
        ...
        * @param title: O titulo da coluna que sejá exibido no cabeçalho
