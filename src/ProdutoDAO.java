...
public class ProdutoDAO {
    //Essa classe fará acesso ao banco de dados e irá conter os metodos de manipulação de dados
    private final Connection CONEXAO_DB;

    //Construtor que inicializa a conexão com o banco de dados utilizando a classe
    ...
    public void inserir(Produto produto){
        ...
        try (PreparedStatement stmt = CONEXAO_DB.prepareStatement(sql))  {//Tentando a criação de um objeto do tipo PreparedStatement{
    ...
    public Produto consultarPorId(int id){
        ...
        try (PreparedStatement stmt = CONEXAO_DB.prepareStatement(sql)){
            ...
            try(ResultSet rs = stmt.executeQuery()){
                if (rs.next()) { //Se houver um resultado retornará verdadeiro,
    ...
    // Metodo para atualizar as informacoes de um produto no banco de dados
